...
import { Twitter, Linkedin, Instagram, Facebook, Sparkles, ArrowRight } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          <div className="mb-8 md:mb-0">
            <Link href="/" className="flex items-center gap-2 group mb-4 w-[130px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-border/50 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="absolute -bottom-1 left-0 h-[1px] w-0 bg-gradient-to-r from-primary to-accent transition-all duration-300 group-hover:w-full"></span>
            </Link>
